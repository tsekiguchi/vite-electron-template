import { c as create_ssr_component, d as compute_rest_props, i as getContext, e as spread, g as escape_object, f as escape_attribute_value, b as add_attribute } from "./ssr.js";
...
const LinkOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${spread(
    ...
    {}
  )}><path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-linejoin", strokeLinejoin, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="M13.2 9.8a3.4 3.4 0 0 0-4.8 0L5 13.2A3.4 3.4 0 0 0 9.8 18l.3-.3m-.3-4.5a3.4 3.4 0 0 0 4.8 0L18 9.8A3.4 3.4 0 0 0 13.2 5l-1 1"></path></svg> `;
});
export {
  LinkOutline as L
};
