import { c as create_ssr_component, d as compute_rest_props, e as spread, g as escape_object, i as getContext, f as escape_attribute_value, b as add_attribute } from "./ssr.js";
...
const SearchOutline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<svg${spread(
    ...
    {}
  )}><path stroke="currentColor"${add_attribute("stroke-linecap", strokeLinecap, 0)}${add_attribute("stroke-width", strokeWidth, 0)} d="m21 21-3.5-3.5M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"></path></svg> `;
});
export {
  SearchOutline as S,
  Wrapper as W,
